  ...
  <div className="card mb-5 mb-lg-0">
    <div className="card-body">
      ...
      <ul className="fa-ul">
        ...
        <li classNAme={data.isStorage?"":"text-muted"}><span className="fa-li"><i className={data.isStorage?"fas fa-check":"fas fa-times"}></i></span>{data.storage} Storage</li>
        ...
        <li classNAme={data.isCommuntityAccess?"":"text-muted"}><span className="fa-li"><i className={data.isCommuntityAccess?"fas fa-check":"fas fa-times"}></i></span>{data.communtityAccess}</li>
